...
function startGame() {
    myGamePiece = new component(18, 18, "red", 10, 120, "color");
...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(60)) {
        ...
        myObstacles.push(new component(10, height, "#1DC6F9", x, 0));
        myObstacles.push(new component(10, x - height - gap, "#EEF35A", x, height + gap));
    }
    for (i = 0; i < myObstacles.length; i += 1) {
        myObstacles[i].x += -1;
